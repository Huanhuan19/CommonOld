...
namespace WCYDataSource
{
    ...
    public class PortCollectionEventArgs : EventArgs
    {
        PortInfo[] _ports;
        public PortCollectionEventArgs(PortInfo[] ports)
        {
            _ports = ports;
        }
    ...
    public delegate void PortCollectionHandler(object sender,PortCollectionEventArgs e );
